namespace StateMachine
{
    ...
    public abstract class State<StateType>
    {
        ...
        protected StateController<StateType> controller { get; private set; }

        /// <summary>
        /// Invoke when this state was changed with state controller.
        /// </summary>
        /// <param name="controller"></param>
        public virtual void Init(StateController<StateType> controller) => this.controller = controller;
